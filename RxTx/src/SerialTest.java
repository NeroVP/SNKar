			...
			try {
				...
				if (input.ready()) {
					...
					try {
						...
						java.text.DecimalFormat df = new java.text.DecimalFormat("0.##"); //Arrondi de deux chiffres après la virgule
                        ...
                        double n = (double) (Math.random() * 2.5); //Random

                        String vitesse = df.format(n); //resultat 

                        // System.out.println(resultat);

                        // System.out.println("Test de connection");

                        String sql = "INSERT INTO donnee(vitesse, position) VALUES ('" + vitesse + "' " + "," + "'" + position + "')";
